 ...
 *     @OA\Property(property="provider_id", type="integer", nullable=true, example=1, description="Provider ID"),
 *     @OA\Property(property="price_decimal", type="number", format="float", nullable=true, example=0.05, description="Message cost"),
